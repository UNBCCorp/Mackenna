...
<div class="modal fade" id="verUsersModal" tabindex="-1" aria-labelledby="verUsersModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="verUsersModalLabel">Información del Usuario</h5>
